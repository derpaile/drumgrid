...
const TRANSLATIONS: Array<[string, string]> = [
  ...
  ["Lautstärke", "Volume"],
  ["Die Zählstimme konnte nicht vorbereitet werden.", "The counting voice could not be prepared."],
  ["Zählstimme auswählen", "Choose counting voice"],
  ["Zählstimme", "Counting voice"],
  ["Spricht das sichtbare Raster: „one and two“ bzw. „eins und zwei“.", "Speaks the visible grid: “one and two” or “eins und zwei”."],
